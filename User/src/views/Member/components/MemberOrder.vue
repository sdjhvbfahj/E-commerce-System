<template>
    <div class="order-container">
        <el-tabs v-model="tabNum" @click="changeTab">
            <!-- tab切换 -->
            ...
            <div class="main-container">
                ...
                <div v-else>
                        ...
                        <div class="body">
                            ...
                            <div class="column state">
                                <p v-if="order.orderState === 1">
                                    <a href="javascript:;" class="green">等待付款</a>
                                </p>
                                <p v-if="order.orderState === 2">
                                    <a href="javascript:;" class="green">等待发货</a>
                                </p>
                                ...
                                <p v-if="order.orderState === 6">
                                    <a href="javascript:;" class="green">已取消</a>
                                </p>
                            </div>
                    ...
                    <div class="pagination-container">
                        <el-pagination background layout="prev, pager, next" :total="orderList.pages * 10" v-model:current-page="currentPage"/>
                    </div>
                </div>
            </div>
        </el-tabs>
...
<script setup lang="ts" name="MemberOrder">
    import {ref, watch} from 'vue'
    import {getUserOrderAPI} from '@/apis/order.ts'
    import type {ParamsItem, OrderItem} from '@/apis/order.ts'
    // 查询订单参数
    const params = ref({
        orderState: 0,
        page: 1,
    ...
    async function changeTab() {
        if(params.value.orderState !== tabNum.value) {
            params.value.orderState = tabNum.value;
            currentPage.value = 1;
            params.value.page = 1;
            await getUserOrder();
        } else {
