...
const HELP_SECTIONS: HelpSection[] = [
    ...
    },
    {
        ...
        articles: [],
        links: [
            { name: '小兔鲜儿 · 主站', desc: '生鲜、居家、数码全品类好物', url: '/' },
            { name: '小兔鲜儿 · 严选', desc: '层层试用的自有品牌商品', url: `/category/${catIdOf(5)}` },
            { name: '小兔鲜儿 · 品牌专区', desc: '合作品牌与联名企划', url: '/brand' },
            { name: '小兔鲜儿 · 专题活动', desc: '换季焕新、厨房升级等活动', url: '/topic' },
        ],
    },
];
...
export function getAboutData(): AboutData {
    return {
        name: '小兔鲜儿',
        slogan: '让日子过得讲究一点',
        intro: '我们相信，好的生活不需要很贵。小兔鲜儿从一颗车厘子开始，把源头好物直接送到你家门口。',
        // 头图只做纯色渐变背景，标题文字由页面叠加（label 传空字符串即可）
        cover: image('', { width: 1240, height: 420, seed: 2026 }),
        story: {
            title: '从一颗车厘子开始',
            paragraphs: [
                '2016 年冬天，团队在智利的一处果园里蹲了整整两周，只为确认一颗车厘子的糖度是否稳定。那一年，我们只做了一件事：把真正好吃的车厘子，用最快的速度送到国内。',
                '十年过去，小兔鲜儿从生鲜做起，慢慢长成了覆盖居家、美食、服饰、母婴、数码等十大品类的品质生活平台。唯一没变的，是每一件商品上架前都要经过试用与质检。',
                '我们不做最便宜的生意，也不追求最全的货架。我们只想让你在挑东西的时候少纠结一点——因为该纠结的部分，我们已经替你做完了。',
            ],
            picture: image('小兔鲜儿 · 品牌故事', { width: 560, height: 420, seed: 3031, subLabel: '产地直采 · 层层试用' }),
        },
        stats: [
        ...
        milestones: [
            ...
            { year: '2023', title: '推出自有品牌', desc: '「小兔严选」上线，从选品走向参与研发与生产。' },
